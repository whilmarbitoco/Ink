...
import com.whilmarbitoco.inkspace.viewmodel.seller.SoldViewModel;
...
public class SoldController extends BaseController {


    private final SoldViewModel viewModel = new SoldViewModel();
